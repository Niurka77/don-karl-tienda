...
const playSound = (type) => {
  try {
    ...
    switch (type) {
      case 'success':
        // Sonido alegre de éxito (dos tonos ascendentes)
...
const ProductoForm = ({ producto, onGuardar, onCancelar }) => {
  ...
  const handleChange = (e) => {
    ...
    // Validación en tiempo real para discount_percent
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              {/* 🆕 NUEVO: Slider visual para descuento */}
              <input
                type="range"
                min="0"
                max="99"

    ...
    <div className="bg-[#FFF8F5] rounded-sm p-6">
      ...
      {cargando ? (
        <div className="text-center py-12">
          ...
          <p className="text-[#9A7480] font-sans text-sm mt-3">Cargando videos...</p>
        </div>
      ) : videos.length === 0 ? (
        <div className="text-center py-16 border border-dashed border-[rgba(212,120,138,0.25)] rounded-sm">
          ...
          <p className="text-[#9A7480] font-sans font-light">No hay videos aún</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[rgba(212,120,138,0.15)]">
                ...
                <th className="text-left py-3 text-[0.55rem] tracking-[0.25em] uppercase font-sans font-light text-[#9A7480]">Título</th>
                <th className="text-left py-3 text-[0.55rem] tracking-[0.25em] uppercase font-sans font-light text-[#9A7480]">Estado</th>
                <th className="text-left py-3 text-[0.55rem] tracking-[0.25em] uppercase font-sans font-light text-[#9A7480]">Fecha</th>
            ...
            <tbody>
              {videos.map((video) => (
                <tr key={video.id} className="border-b border-[rgba(212,120,138,0.08)] hover:bg-[#FDF0F3]/30 transition-colors duration-200">
                  <td className="py-3 text-[#2D2030] font-sans text-sm">{video.sort_order}</td>
                  <td className="py-3">
                    <span className="font-sans text-[#1A1118] text-sm">{video.title}</span>
                    {video.description && (
                  ...
                  <td className="py-3 text-xs text-[#9A7480] font-sans">

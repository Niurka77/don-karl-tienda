            ...
            <Link to="/" className="flex-shrink-0 group">
              <div className="flex flex-col items-center">
                <div className="relative">
                  ...
                  <svg className="absolute -top-2 -left-8 w-6 h-6 text-kb-pink opacity-60 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/>
                    <path d="M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z"/>
                  </svg>
                  
                  <span className="text-4xl md:text-5xl font-black tracking-wider bg-gradient-to-r from-kb-pink-dark via-kb-pink to-kb-pink-dark bg-clip-text text-transparent group-hover:scale-105 transition-transform duration-300">
                    KB
                  </span>
                  
                  <svg className="absolute -bottom-2 -right-8 w-6 h-6 text-kb-pink opacity-60 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/>
                  </svg>
                </div>
                <span className="text-[10px] md:text-xs text-kb-pink-dark font-medium tracking-[0.3em] uppercase mt-1 group-hover:text-kb-pink transition-colors">
                  Dresses and More
                </span>
              </div>
            </Link>

          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3">
              {[
                ...
                { label: 'Vestidos', action: () => onNavigate('/?categoria=vestidos') },
                { label: 'Carteras', action: () => onNavigate('/?categoria=carteras') },
                { label: 'Novedades', action: () => onNavigate('/?orden=nuevo') },
              ].map((item, i) => (
                <li key={i}>
                  <button
                    onClick={item.action}
                    style={{ fontSize: '0.8rem', color: p.textSoft, fontWeight: 300, fontFamily: 'ui-sans-serif, system-ui, sans-serif', background: 'none', border: 'none', cursor: 'pointer', transition: 'all 0.3s ease', textAlign: 'left' }}
              ...
              {[
                ...
                <li key={i}>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ fontSize: '0.8rem', color: p.textSoft, fontWeight: 300, fontFamily: 'ui-sans-serif, system-ui, sans-serif', transition: 'all 0.3s ease' }}
                    onMouseEnter={(e) => { e.currentTarget.style.color = p.roseDeep; e.currentTarget.style.paddingLeft = '8px' }}
                    onMouseLeave={(e) => { e.currentTarget.style.color = p.textSoft; e.currentTarget.style.paddingLeft = '0' }}
                  >
                    {item.label}
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-4 mb-8">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span style={{ color: p.textSoft, fontSize: '0.82rem', fontWeight: 300, fontFamily: 'ui-sans-serif, system-ui, sans-serif' }}>
                    {item.text}
                  </span>
                </li>
              ))}
            ...
            <a
              ...
              style={{
                ...
                letterSpacing: '0.15em', fontFamily: 'ui-sans-serif, system-ui, sans-serif',

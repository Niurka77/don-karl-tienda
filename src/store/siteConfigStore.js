...
const defaultConfig = {
  ...
  textures: {
    ...
    about: { url: '', opacity: 0.03, blend: 'multiply', bgColor: '' },
  ...
  texts: {
    ...
    catalog_eyebrow: 'Colección actual',
    catalog_heading: 'Todos los productos',
    catalog_heading_accent: 'productos',
    ...
    categories_eyebrow: 'Explora',
    categories_heading_accent: 'categoría',
    about_title: 'Nuestra historia',
    about_description: 'KB Dresses & More nació en Chiclayo con una idea simple: traer moda importada de Estados Unidos con calidad y estilo para la mujer peruana.',
    about_detail: 'Seleccionamos cada pieza con ojo editorial: carteras, vestidos, billeteras y accesorios de marcas originales. Coordina tu compra por WhatsApp y recoge en tienda o recíbelo en casa.',
    about_location: 'Chiclayo, Perú',
    about_cta: 'Hablemos por WhatsApp',

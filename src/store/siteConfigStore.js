...
const defaultConfig = {
  ...
  texts: {
    ...
    banner_sale_title: 'Nueva Colección',
    banner_sale_eyebrow: 'Summer Edit',
    banner_sale_cta: 'Descubrir',
    banner_new_title: 'Los más pedidos',
    banner_new_eyebrow: 'New Arrivals',
    banner_new_cta: 'Ver ahora',
